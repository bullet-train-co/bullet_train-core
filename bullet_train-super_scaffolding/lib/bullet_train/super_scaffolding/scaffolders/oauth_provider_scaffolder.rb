    ...
    module Scaffolders
      class OauthProviderScaffolder < Scaffolder
        def run
          ...
          oauth_scaffold_add_line_to_file("./app/views/shared/_menu.html.erb", "<%= render 'account/integrations/stripe_installations/menu_item' if stripe_enabled? %>", "<%# 🚅 super scaffolding will insert new oauth providers above this line. %>", options, prepend: true)
