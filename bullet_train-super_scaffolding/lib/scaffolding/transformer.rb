  ...
  def add_attributes_to_various_views(attributes, scaffolding_options = {})
    ...
    attributes.each_with_index do |attribute_definition, index|
      ...
      unless cli_options["skip-show"]
        ...
        if child == "Membership"
          scaffold_add_line_to_file("./app/views/account/scaffolding/completely_concrete/tangible_things/_attributes.html.erb", field_content.strip, ERB_NEW_FIELDS_HOOK, prepend: true, suppress_could_not_find: show_page_doesnt_exist)
        end
