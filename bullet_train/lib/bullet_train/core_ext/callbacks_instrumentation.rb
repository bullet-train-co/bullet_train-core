...
::ActiveSupport::Callbacks::ClassMethods.prepend Module.new {
...
::ActiveSupport::Callbacks::Callback.prepend Module.new {
  def compiled
...
class ActiveSupport::Callbacks::LogSubscriber < ActiveSupport::LogSubscriber
