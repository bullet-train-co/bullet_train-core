...
# docker build -t bullet_train/dev -f core/dockerfiles/Dockerfile.dev --build-arg BULLET_TRAIN_VERSION=x.x.x .
#
# Sometimes it's handy to get long output and skip the cache:
# docker build -t bullet_train/dev -f core/dockerfiles/Dockerfile.dev --build-arg BULLET_TRAIN_VERSION=1.23.0 . --no-cache --progress=plain
#
